...
- [ ] **[agent] Open Graph image** (1200x630, the question and first answer line in the page style) so shared links preview properly; the brief asks for one and the page has none yet.
